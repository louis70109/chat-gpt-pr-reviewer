...
class AiBot(ABC):
    ...
    __problems = "Best practices, errors, issues, potential crashes or unhandled exceptions"
    __chat_gpt_ask_long="""
As a staff software engineer, you must code review and find some best practices with the following code.
